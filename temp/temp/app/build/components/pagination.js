...
var Pagination = React.createClass({displayName: "Pagination",
    ...
    render: function() {
        ...
        var nodes = pages.map(function(item, index) {
            ...
            return (
                React.createElement("span", {onClick: this.onPage(item.page), key: item + ' ' + index, style: style}, item.text)
            )
        }.bind(this));
        return (
            React.createElement("div", null, 
                nodes, 
                React.createElement("span", null, "  共", this.props.numberOfPages, "页"), 
                React.createElement("span", null, "  转到  "), 
