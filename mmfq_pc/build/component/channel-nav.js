        ...
        value: function render() {
            ...
            var categories = this.state.category.map(function (item, index) {
                return React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { style: { float: 'left', width: 35, height: 35, marginLeft: 25, marginRight: 15, display: 'flex' } },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'span',
                                { className: 'all_kinds', style: { width: 192 } },
                                '全部分类'
                            ),
                            React.createElement(
                                'div',
                                ...
                                React.createElement(
                                    'div',
                                    { className: 'all_right_list infoShowCont', style: { left: 194, display: 'none', top: 0 } },
                                    React.createElement(
                                        'ul',
                        ...
                        React.createElement(
                            ...
                            this.props.now == 1 ? React.createElement(
                                'a',
                            ...
                            this.props.now == 2 ? React.createElement(
                                'a',
                                { href: 'combo.html', className: 'now' },
                                ' 网红套餐'
                            ) : React.createElement(
                                'a',
                                { href: 'combo.html' },
                            ...
                            this.props.now == 3 ? React.createElement(
                                'a',
                                { href: 'goods.html', className: 'now' },
                                ' 限时秒杀'
                            ) : React.createElement(
                                'a',
                                { href: 'goods.html' },
