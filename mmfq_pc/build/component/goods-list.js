                    ...
                    React.createElement(
                        ...
                        item[this.props.subTypeName].map(function (subItem, subIndex) {
                            return React.createElement(
                                'a',
                                { key: subIndex,
                                    onClick: this.onChange(index, subItem[this.props.subItemName], subItem[this.props.subItemId]) },
                                React.createElement(
                                    'span',
                                    null,
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(DoubleFilter, { kindName: '地区', typeName: 'proname', subTypeName: 'cityList', subItemName: 'cityname',
                    cxt: this,
                    items: !!this.state.areas ? this.state.areas : [], subItemId: 'cityid',
                    callbackId: 'cityId' }),
                React.createElement(DoubleFilter, { kindName: '类别', typeName: 'categoryName', subTypeName: 'categoryList',
            ...
            React.createElement(
                ...
                React.createElement(Pagination, { cxt: this, numberOfPages: this.state.index })
            )
        );
    }
});