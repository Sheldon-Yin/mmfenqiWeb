...
var R_About = function (_React$Component) {
    _inherits(R_About, _React$Component);

    function R_About(props) {
        _classCallCheck(this, R_About);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(R_About).call(this, props));
    ...
    _createClass(R_About, [{
        ...
        key: 'changeWork',
        value: function changeWork(item) {
            this.setState({
                nowWork: item.name,
                nowDuty: item.duty,
        ...
        value: function render() {
            ...
            var works = this.works.map(function (item, index) {
                return React.createElement(
                    'span',
                    { onClick: _this2.changeWork.bind(_this2, item), style: { marginRight: 22, marginTop: 10, display: 'inline-block', color: _this2.state.nowWork == item.name ? '#FD657A' : '#666', cursor: 'pointer' } },
                    item.name
                );
            });
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    null,
                    React.createElement('img', { src: '../static/images/about/banner.jpg', style: { width: '100%' } })
                ),
                React.createElement(
                    'div',
                    { className: 'wrap', style: { width: 1200, margin: '0 auto' } },
                    React.createElement(
                        'div',
                        {
                        ...
                        React.createElement(
                            'div',
                            { onClick: this.changeState.bind(this, 1), style: { cursor: 'pointer', marginTop: 40 } },
                            this.state.nowState == 1 ? React.createElement(
                                'div',
                                { style: { color: '#FD657A' } },
                                '公司简介',
                                React.createElement('img', { src: '../static/images/about/red-dot.png',
                                    style: { position: 'absolute', marginLeft: 40, marginTop: -2 } })
                            ) : React.createElement(
                                'div',
                                null,
                                '公司简介',
                                React.createElement('img', { src: '../static/images/about/grey-dot.png',
                                    style: { position: 'absolute', marginLeft: 53, marginTop: 5 } })
                            )
                        ),
                        React.createElement(
                            'div',
                            { onClick: this.changeState.bind(this, 2), style: { cursor: 'pointer', marginTop: 40 } },
                            this.state.nowState == 2 ? React.createElement(
                                'div',
                                { style: { color: '#FD657A' } },
                                '团队风采',
                                React.createElement('img', { src: '../static/images/about/red-dot.png',
                        ...
                        React.createElement(
                            'div',
                            { onClick: this.changeState.bind(this, 3), style: { cursor: 'pointer', marginTop: 40 } },
                            this.state.nowState == 3 ? React.createElement(
                                'div',
                                { style: { color: '#FD657A' } },
                                '联系我们',
                                React.createElement('img', { src: '../static/images/about/red-dot.png',
                        ...
                        React.createElement(
                            'div',
                            { onClick: this.changeState.bind(this, 4), style: { cursor: 'pointer', marginTop: 40 } },
                            this.state.nowState == 4 ? React.createElement(
                                'div',
                                { style: { color: '#FD657A' } },
                                '加入我们',
                                React.createElement('img', { src: '../static/images/about/red-dot.png',
                    ...
                    React.createElement(
                        ...
                        this.state.nowState == 1 ? React.createElement(
                            ...
                            React.createElement('div', {
                                style: { width: '100%', backgroundColor: '#f0f0f0', marginTop: 15, marginBottom: 30, height: 1 } }),
                            React.createElement(
                                'div',
                                { style: { fontSize: 14, paddingLeft: 30, color: '#808080' } },
                                '美眉分期是杭州优呗网络科技有限公司旗下网站，国内首家女性消费金融平台，公司成立于2015年5月，总部位于杭州市 西湖区文 三路金融圈，是面向在校女大学生提供微整形分期付款服务的在线平台，创始团队拥有丰富的金融、医美、电商、校园 推广等行业 经验，为女大学生提供安全可靠的分期整形产品、完善的微整体验和超前的分期服务；已与多家国内知名整形医院签 订战略合作伙 伴，医美专家全程陪同，确保过程正规安全可靠，分期付款轻松求美。'
                            )
                        ) : '',
                        this.state.nowState == 2 ? React.createElement(
                            'div',
                            ...
                            React.createElement(
                                'div',
                                { style: { fontSize: 14, paddingLeft: 30, color: '#808080' } },
                                React.createElement('img', { src: '../static/images/about/6.jpg',
                                    style: { width: '32%', marginRight: '1%' } }),
                                React.createElement('img', { src: '../static/images/about/2.jpg',
                                    style: { width: '32%', marginRight: '1%' } }),
                                React.createElement('img', { src: '../static/images/about/3.jpg', style: { width: '33%' } }),
                                React.createElement('img', { src: '../static/images/about/4.jpg',
                                    style: { width: '32%', marginRight: '1%', marginTop: '1%' } }),
                                React.createElement('img', { src: '../static/images/about/5.jpg',
                                    style: { width: '32%', marginRight: '1%', marginTop: '1%' } }),
                                React.createElement('img', { src: '../static/images/about/1.jpg', style: { width: '32%', marginTop: '1%' } })
                            )
                        ) : '',
                        this.state.nowState == 3 ? React.createElement(
                            'div',
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        null,
                                        '公司地址：杭州市西湖区文三路478号华星时代广场B座403室'
                                    ),
                                    React.createElement(
                                        'div',
                                        { style: { marginTop: 30 } },
                                ...
                                React.createElement(
                                    'div',
                                    { style: { width: '49%', float: 'left' } },
                                    React.createElement('img', { src: '../static/images/about/map.jpg', style: { width: '100%' } })
                                )
                            )
                        ) : '',
                        this.state.nowState == 4 ? React.createElement(
