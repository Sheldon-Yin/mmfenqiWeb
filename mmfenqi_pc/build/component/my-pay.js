...
var RMy_pay = function (_React$Component) {
    ...
    function RMy_pay() {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RMy_pay).call(this));
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'div',
                                { style: { paddingLeft: '40px', width: '815px' } },
                                React.createElement('img', { src: '../static/images/my-pay/pay1.png', alt: '' })
                            ),
                            React.createElement(
                                'div',
                                { className: '_btn', onClick: this.alipayTrade.bind(this), style: { padding: '7px', borderRadius: '0' } },
                                '去支付'
                            )
                        )
                    )
