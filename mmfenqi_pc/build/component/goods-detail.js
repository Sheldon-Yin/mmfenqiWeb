    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'a',
                    { href: '#doc-detail', style: this.styles.link },
                    '医生简介'
                ),
                React.createElement(
                    'span',
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('input', { type: 'button', value: '立即提额',
...
var DetailOrder = React.createClass({
    ...
    createOrderConfirm: function createOrderConfirm(orderData) {
        ...
        $.ajax({
            ...
            success: function success(res) {
                ...
                if (res.result == 0) {
                    ...
                    locationSearchString = locationSearchString + 'orderId=' + order.orderId + '&orderNo=' + order.orderNo + '&orderName=' + order.orderName + '&downpayAmount=' + order.downpayAmount + '&creditPay=' + res.data.goodsConfirmOrderResponse.creditPayment + '&telephone=' + user.telephone + '&startPhone=' + user.telephone.substring(0, 3) + "****" + user.telephone.substring(7, 11);
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(ComboBox, { cxt: this, callbackSetValue: this.setInsurance, items: insurance }),
                        React.createElement(
                            'span',
                            {
                                style: { lineHeight: '40px', marginLeft: 10 } },
                            '元'
                        ),
