                    ...
                    <div style={{height: 580,width:980,marginLeft:110,backgroundColor: '#fff'}}>
                        ...
                        <div
                                ...
                                <div style={{width: 342,marginLeft: 40}}>
                                    {
                                        this.phoneBool ?
                                            <div>
                                                <span style={{color:'#FD647A'}}>手机号格式错误</span>
                                                <input placeholder="请输入手机号" value={this.state.phoneNumber}
                                ...
                                <div style={{width: 342,marginLeft: 40}}>
                                    {
                                        this.pwdBool ?
                                            <div>
                                                <span style={{color:'#FD647A'}}>密码长度在6-16位之间</span>
                            ...
                            <div style={{marginTop: 25}}>
                                <p>
                                    <a href="forget.html"
                                       style={{float:'right',marginRight:40,color:'#FD647A',textDecoration:'underline'}}>忘记密码？</a>
                                </p>
                            </div>
                            <div onClick={this.goToLogin.bind(this)} value="登陆"
