...
define(function (require, exports, module) {
    module.exports = function (app) {
        ...
        app.register.controller('LoginFastCtrl', ['$scope','Login','$interval','$location',
            function ($scope,Login,$interval,$location) {
                $scope.$root.title = '快捷登录';
                $scope.telephone = ($location.search().telephone != 'undefined' && $location.search().telephone != undefined) ? Number($location.search().telephone) : Number('');
